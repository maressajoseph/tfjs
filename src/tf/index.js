...
// is connected to every node in the prev layer)
modelLinear.add(tf.layers.dense({ units: 1, inputShape: [1] }))

// specify the loss and optimizer function for the model
// loss function maps values of one/more variables into a real number that represents costs associated with the value
